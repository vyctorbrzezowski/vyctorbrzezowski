...
I'm Vyctor, a Brazilian Design Engineer.

I studied Computer Engineering at UnB and somehow ended up caring a lot about the tiny details between product, design, and code.

I build tools and automation systems for content, design, and coding workflows.

My current mission is making LLM-generated UI and UX actually good. Not just steering models away from the usual slop patterns, but giving them better vocabulary, context, and product judgment so they can make stronger decisions: generating a UI from scratch, improving existing work, refactoring toward a design system, or reviewing PRs like a CI check.
...
- At Direção Concursos, I was a founding engineer on an LMS 2.0 platform that, back in 2017, combined video lessons, PDFs, question banks, and ML-powered learning data for millions of students preparing for public-sector exams. Years before the current AI wave.
